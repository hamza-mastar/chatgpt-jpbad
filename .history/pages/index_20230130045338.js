    ...
    <div class="h-full px-5 sm:px-6">
      <div class="h-full w-full max-w-xl mx-auto flex flex-col after:mt-auto after:flex-1">
        ...
        <div>
          ...
          <textarea class="form-textarea text-sm pt-2 w-full resize-none" rows="4"
          type="textarea"
          name="experience"
        ...
        <div class="whitespace-pre-wrap text-gray-800 h-auto text-lg divide-y px-4 pt-5 pb-4 sm:p-6 sm:pb-4 "
