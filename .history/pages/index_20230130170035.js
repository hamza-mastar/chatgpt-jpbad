  ...
  return (
    ...
    <div class="h-full px-5 sm:px-6">
      ...
      <CopyToClipboard text={result}
        ...
        <div class="mx-4 bottom-2 left-0 right-0 px-2 py-2 font-semibold text-sm text-slate-900 bg-slate-50/90 backdrop-blur-sm ring-1 ring-slate-900/10 space-x-4 rounded-xl shadow-2xl sm:mt-4 my-6 h-auto min-h-[5rem] sm:min-h-[1rem]">
