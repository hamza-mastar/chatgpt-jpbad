                        ...
                        <div className=" p-6 pb-0 h-[calc(100vh-6rem)]">
                            <div className="form-textarea relative text-base w-full p-4 px-8 overflow-scroll h-[calc(100%-1rem)] shadow-2xl flex items-center justify-center">
                                <div className=" font-mono text-left text-base font-semibold absolute top-4 left-4">
                                    ...
                                    <span class="typed">Hi I am Write My PRD bot,
                                      Your PRD writing Assistant 🙌 

                                      Tell me what does your Product do?
                                      And I will try to help you kickstart your PRD writing journey.</span>
