...
You will need to read over and edit! Don't be lazy </p></div></div></div>
  ...
  <button  class="grow h-16 p-0 sm:p-[1.1rem] w-20 sm:w-auto  rounded-lg flex items-center justify-center bg-gray-50 border-gray-300 text-gray-600 hover:bg-gray-100 shadow-lg border">
  {/* {copy ? 'Copied' : "Copy"} */}
  </button>
  </CopyToClipboard>
