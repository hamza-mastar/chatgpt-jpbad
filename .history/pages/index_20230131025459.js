...
import Bot1 from './bot1.svg'
import Bot2 from './bot2.svg'
import Bot3 from './bot3.svg'
...
You will need to read over and edit! Don't be lazy </p></div></div></div>
  ...
  <img className="youlogo" src={Bot1} alt="Your Logo" />
  </button>
  </CopyToClipboard>
  <button class="p-4 grow w-auto h-16 rounded-lg flex items-center justify-center bg-gray-50 border border-gray-300 text-gray-600 hover:bg-gray-100 shadow-lg text-xs sm:text-base"> Copy and Open Slack
  <img className="youlogo" src={Bot2} alt="Your Logo" />
   </button>
  <button class="p-4 grow w-auto h-16 rounded-lg flex items-center justify-center bg-gray-50 border border-gray-300 text-gray-600 hover:bg-gray-100 shadow-lg text-xs sm:text-base"> Download 
  <img className="youlogo" src={Bot3} alt="Your Logo" />
  </button>
