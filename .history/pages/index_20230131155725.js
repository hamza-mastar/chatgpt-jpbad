...
<div className="modal  font-medium rounded-lg  text-black  shadow-md hover:shadow-2xl focus:shadow-2xl inline-block shadow-lg">
  <div onClick={toggleModal} className={styles.overlay}></div>
  <div className="modal-content">
    <button className="close-modal" onClick={toggleModal} >
    <img src={close} alt="Your SVG" />
      
    </button>
    {/* <img className="youlogo" src={logo} alt="Your Logo" /> */}
    <div className="youare">You are one step away</div>
    <div className="btn-di " >
        
    
       
                <div>
                    <a href="/login" className="btn-lo mt-4 h-14 px-4 py-2 hover:bg-amber-200 font-medium rounded-lg text-lg bg-green-100 text-black  border shadow-md hover:shadow-2xl focus:shadow-2xl inline-block" >
      Log in 🤝
    </a>
                <a href="/signup" type="submit" className="btn-lo mt-4 h-14 px-4 py-2 hover:bg-amber-200 font-medium rounded-lg text-lg bg-amber-100 text-black  border shadow-md hover:shadow-2xl focus:shadow-2xl inline-block" >
      Sing in 👍
    </a>
                </div>
    </div> 
...
<div class="feedback-textarea"  style="background: transparent !important;">
<textarea required="" data-test="feedback-input" rows="10" name="Please let us know what's your feedback?" id="Please let us know what's your feedback?" class="w-full" placeholder="Please let us know what's your feedback..."  style="resize: none;">
</textarea>
</div>
...
{/* <!----> */}
<svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  style="fill: var(--widget-text-primary-color);"><path fill="none" d="M0 0h24v24H0z" >
...
<button type="button" class="font-medium flex items-center justify-center shadow-sm px-4 py-2 focus:outline-none focus:ring-1 focus:ring-offset-1 border border-gray-300 text-gray-900 bg-white hover:bg-gray-50 focus:ring-gray-500 rounded-lg widget-background v-popper--has-tooltip" data-test="upload-file"   >
  <div class="flex items-center justify-center w-full" >
    {/* <!----> */}
    <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  style="fill: var(--widget-text-primary-color);">
...
<div class="w-full flex flex-col" ><input type="file" class="invisible h-0 w-0" multiple="" aria-label="attach feedback file" accept="audio/aac,image/avif,video/x-msvideo,text/csv,application/msword,image/gif,text/html,image/jpeg,application/json,audio/mpeg,video/mp4,video/mpeg,audio/ogg,image/png,application/pdf,text/plain,audio/wav,video/webm,image/webp" ><!----></div>
<div  style="margin-bottom: 75px;">
<div class="w-full" >
<label class="text-sm w-full"  style="color: var(--widget-text-primary-color);">Email</label>
