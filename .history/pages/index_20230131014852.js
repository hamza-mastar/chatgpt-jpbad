  ...
  return (
    ...
    <div class="h-full px-5 sm:px-6">
      <div class="h-full w-full max-w-xl mx-auto flex flex-col after:mt-auto after:flex-1">
                            ...
                            <div className="form-textarea relative text-base w-full p-4 px-8 overflow-scroll h-[calc(100%-1rem)] shadow-2xl flex items-center justify-center">
                                ...
                                {what && (
                                    <div className={styles.typed}>
                                      <Typed
                                    strings={[
                                      "Hi I am hamza My PRD bot Your PRD writing Assistant 🙌 Tell me what does your Product do?And I will try to help you kickstart your PRD writing journey",
        ...
        <Typed
        strings={[
          "Hi I am Write My PRD bot Your PRD writing Assistant 🙌 Tell me what does your Product do?And I will try to help you kickstart your PRD writing journey",
