  ...
  return (
    ...
    <div class="h-full px-5 sm:px-6">
      <div class="h-full w-full max-w-xl mx-auto flex flex-col after:mt-auto after:flex-1">
        ...
        <div class="is-typed pb-0 h-[calc(100vh-6rem)] form-textarea relative text-base w-full p-4 px-8 overflow-scroll   flex items-center "
        
          

          
        />
        <div class ="text-pink-600 font-mono text-left text-base font-semibold"
