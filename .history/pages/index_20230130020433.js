...
export default function Home() {
  ...
  return (
    ...
    <div className="  h-full px-5 sm:px-6 bg-white" >
    <div className="h-full w-full max-w-xl mx-auto flex flex-col after:mt-auto after:flex-1">
    <header className= "sm:flex-1 mt-10 flex mb-auto sm:py-10 pt-6 items-center sm:justify-between flex-col sm:flex-row">
    ...
    <div>
      ...
      <main className={styles.main}>
        <h3 className=' bg-black' >Christmas gift generator 🎁 💡</h3>
