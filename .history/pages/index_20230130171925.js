          ...
          <div class="relative  lg:fixed right-0 bottom-0 lg:block lg:w-1/2 overflow-hidden sm:px-5 lg:h-full h-auto  top-12">
            <div class="absolute inset-0 bg-gradient-to-b from-pink-100 to-white  -z-10" >
              <div class="relative lg:fixed right-0 bottom-0 lg:block lg:w-1/2 sm:px-5 lg:h-full h-auto overflow-scroll top-12">
                ...
                <div className={styles.formTextarea } class=" relative text-base overflow-scroll w-full p-4 px-8  h-[calc(100%-1rem)] shadow-2xl flex items-center justify-center" >
