...
export default function Home() {
  ...
  return (
    ...
    <body class="h-full px-5 sm:px-6">
    ...
    <div class="h-full px-5 sm:px-6">
          ...
          <div class="relative  lg:fixed right-0 bottom-0 lg:block lg:w-1/2 overflow-hidden sm:px-5 lg:h-full h-auto  top-12">
            <div class="absolute inset-0 bg-gradient-to-b from-pink-100 to-white  -z-10" >
              <div class="relative lg:fixed right-0 bottom-0 lg:block lg:w-1/2 overflow-hidden sm:px-5 lg:h-full h-auto overflow-y-auto top-12">
                ...
                <div class="form-textarea relative text-base overflow-scroll w-full p-4 px-8  h-[calc(100%-1rem)] shadow-2xl flex items-center justify-center" >
      ...
      <CopyToClipboard text={result}
        ...
        <div class="mx-4 bottom-2 left-0 right-0 px-2 py-0 font-semibold text-sm text-slate-900 bg-slate-50/90 backdrop-blur-sm ring-1 ring-slate-900/10 space-x-4 rounded-xl shadow-2xl sm:mt-4 my-6 h-auto min-h-[5rem] sm:min-h-[1rem]">
            <div class="flex items-center justify-between gap-1 sm:gap-4 text-white text-sm font-bold font-mono leading-6 bg-stripes-indigo rounded-lg h-full">
